    ...
    <form method="POST" action="{{ route('admin.apartments.update', $apartment->id) }}"
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control @error(' title') is-invalid @enderror" id="inputTitle" name="title"
                value="{{ old('title') ? old('title') : $apartment->title }}" required minlength="8">
        ...
        <div class="col-md-3">
            ...
            <input type="number" class="form-control @error(' price') is-invalid @enderror" id="inputPrice" name="price"
                value="{{ old('price') ? old('price') : $apartment->price }}" required step=".01">
            <div class="invalid-feedback">
        ...
        <div class="col-md-3">
            <div class="form-switch">
                ...
                <input type="checkbox" class="form-check-input" value="1" name="visibile" {{ $apartment->visibile ?
                'checked' : '' }}>
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="accordion-body">
                            ...
                            <div class="form-check form-check @error('rules') is-invalid @enderror">
                                ...
                                <label class="form-check-label" for="tagCheckbox_{{ $loop->index }}">{{ $rule->name
                                    }}</label>
                            </div>
                            @endforeach
                        ...
                        <div class="accordion-body">
                            ...
                            <div class="form-check form-check @error('services') is-invalid @enderror">
                                ...
                                <input class="form-check-input servicesCheck @error('services') is-invalid @enderror"
                                    ...
                                    name="services[]" {{ in_array($service->id,
                                $apartment->services()->get()->pluck('id')->toArray()) ? 'checked' : '' }}>
...
<script>
    ...
    const valueAddress = document.querySelector('#inputAddress')
